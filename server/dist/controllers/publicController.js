 ...
 */
export async function getPublicLeaderboard(_request, reply) {
 ...
 */
export async function getPublicAnnouncements(_request, reply) {
 ...
 */
export async function getPublicTeams(_request, reply) {
 ...
 */
export async function getFanFavoriteLeaderboard(_request, reply) {
 ...
 */
export async function getPublicTasks(_request, reply) {
 ...
 */
export async function getPublicTimeline(_request, reply) {
