...
import { Sparkles, User, Lock, Menu, X, PartyPopper, LogIn } from 'lucide-react';
    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-[#0B0A16]/85 backdrop-blur-xl border-b border-white/10 shadow-2xl">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-2.5">
          ...
          <Link
            to="/student"
            className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl glass-card text-slate-100 hover:text-white font-semibold text-xs border border-white/10 hover:border-carnival-cyan/50 transition-all"
          >
            <User className="w-3.5 h-3.5 text-carnival-cyan" />
            <span>Student Portal</span>
          </Link>

          <Link
            to="/admin"
            className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-gradient-to-r from-carnival-crimson to-carnival-purple text-white font-bold text-xs shadow-neon-crimson hover:scale-105 transition-all"
          >
