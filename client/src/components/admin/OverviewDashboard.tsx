      ...
      <div className="p-6 sm:p-8 rounded-2xl glass-card border border-carnival-crimson/40 shadow-neon-crimson relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-6">
        <div className="space-y-2 text-center md:text-left">
          ...
          <p className="text-slate-300 text-sm max-w-2xl">
            Live telemetry of registered teams, qualification metrics, daily point progression, and broadcast controls.
          </p>
        </div>

        <button
          onClick={triggerCarnivalConfetti}
          className="px-6 py-3 rounded-xl bg-gradient-to-r from-carnival-gold to-carnival-amber text-slate-950 font-black text-sm shadow-neon-gold hover:scale-105 transition-all flex items-center gap-2"
        >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        ...
        >
          ...
          <div className="flex items-center justify-between mb-3">
            <span className="text-xs text-slate-400 font-mono uppercase tracking-wider font-bold">Registered</span>
        ...
        >
          ...
          <div className="flex items-center justify-between mb-3">
            <span className="text-xs text-slate-400 font-mono uppercase tracking-wider font-bold">Qualified</span>
        ...
        >
          ...
          <div className="flex items-center justify-between mb-3">
            <span className="text-xs text-slate-400 font-mono uppercase tracking-wider font-bold">Eliminated</span>
        ...
        >
          ...
          <div className="flex items-center justify-between mb-3">
            <span className="text-xs text-slate-400 font-mono uppercase tracking-wider font-bold">Total Submissions</span>
            <div className="p-2 rounded-xl bg-carnival-gold/10 text-carnival-gold border border-carnival-gold/30">
              <FileCode className="w-5 h-5" />
            </div>
          </div>
          <div className="text-3xl sm:text-4xl font-black text-white font-mono">54 Repos</div>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-white/10">
          <div>
            ...
            <p className="text-slate-400 text-xs mt-1">
              Live line chart of points accumulated across 10 Days for top contenders.
            </p>
          </div>
