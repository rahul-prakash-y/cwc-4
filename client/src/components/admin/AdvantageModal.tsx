          ...
          <form onSubmit={handleGrant} className="space-y-5 relative z-10">
            ...
            <div className="flex items-center justify-between p-3.5 rounded-2xl bg-black/40 border border-white/10">
              <div className="flex items-center gap-2.5">
                <Shield className="w-5 h-5 text-carnival-cyan" />
                <div>
                  <div className="text-xs font-mono font-bold text-white">Grant Immunity Shield</div>
                  <div className="text-[10px] text-slate-400">Protect team from eviction on missed sprint</div>
                </div>
              </div>
              <button
                type="button"
                ...
                className={`w-12 h-6 rounded-full transition-colors relative p-1 cursor-pointer ${
                  isImmunity ? 'bg-carnival-cyan' : 'bg-white/20'
                }`}
              >
                <div
