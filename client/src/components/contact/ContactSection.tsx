...
import { Phone, Mail, MapPin, User, GraduationCap, Building2, Copy, Check, ExternalLink, MessageSquare } from 'lucide-react';
    ...
    <section id="contact" className="py-20 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center space-y-4 mb-14">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full glass-card border border-carnival-crimson/30 text-carnival-crimson text-xs font-mono font-bold tracking-widest uppercase shadow-neon-crimson">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
          {/* LEFT SIDE: Faculty & Student Coordinators Cards */}
          <div className="space-y-6">
            ...
            <div className="space-y-4 max-h-[600px] overflow-y-auto pr-1">
              {allCoordinators.map((person) => (
                <div
                  key={person.name}
                  className="glass-card rounded-2xl p-5 border border-white/10 hover:border-carnival-crimson/50 transition-all group"
                >
                    ...
                    <div className="flex items-center gap-3">
                      <div
                        className={`w-10 h-10 rounded-xl flex items-center justify-center font-bold text-sm border ${
                          person.type === 'faculty'
                            ? 'bg-carnival-gold/10 text-carnival-gold border-carnival-gold/30'
                            : 'bg-carnival-cyan/10 text-carnival-cyan border-carnival-cyan/30'
                        }`}
                      >
                  ...
                  <div className="pt-3 border-t border-white/10 grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
                    <a
                      ...
                      className="flex items-center justify-between p-2.5 rounded-xl bg-white/5 hover:bg-carnival-crimson/20 border border-white/5 hover:border-carnival-crimson/40 text-slate-200 transition-all font-mono"
                    >
                      <span className="flex items-center gap-2">
                        <Phone className="w-3.5 h-3.5 text-carnival-crimson" />
                        {person.phone}
                      </span>
                      <button
                        type="button"
                    ...
                    <a
                      ...
                      className="flex items-center justify-between p-2.5 rounded-xl bg-white/5 hover:bg-carnival-cyan/20 border border-white/5 hover:border-carnival-cyan/40 text-slate-200 transition-all font-mono"
                    >
                      <span className="flex items-center gap-2 truncate">
                        <Mail className="w-3.5 h-3.5 text-carnival-cyan shrink-0" />
          ...
          {/* RIGHT SIDE: Venue Details & Embedded Google Maps Iframe */}
          <div className="glass-card rounded-3xl p-6 sm:p-8 border border-white/10 space-y-6 bg-[#120E29]/80">
            <div className="flex items-center justify-between gap-4">
              <div className="flex items-center gap-3">
                <div className="p-3 rounded-2xl bg-carnival-crimson/20 border border-carnival-crimson/40 text-carnival-crimson">
                  <MapPin className="w-6 h-6 animate-bounce" />
                </div>
                <div>
                  <h3 className="text-xl font-bold text-white">Event Venue</h3>
                  <p className="text-xs text-carnival-gold font-mono">Main University Auditorium</p>
                </div>
              </div>
              ...
              <a
                ...
                className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-white/10 hover:bg-white/20 text-xs font-semibold text-slate-200 border border-white/10 transition-all"
              >
                <span>Open Maps</span>
            ...
            <div className="p-4 rounded-2xl bg-white/5 border border-white/10 text-xs space-y-1 text-slate-300">
              <p className="font-bold text-white">Innovation Block, Tech Campus</p>
              <p>Code With Curious Arena, Grand Auditorium Ground Floor</p>
              <p className="text-slate-400 font-mono">Landmark: Opposite Central Central Library & Incubation Hub</p>
            </div>

            {/* Google Maps Embedded Iframe */}
            <div className="relative w-full h-[340px] rounded-2xl overflow-hidden border border-white/10 shadow-2xl">
              <iframe
                ...
                width="100%"
                height="100%"
                style={{ border: 0, filter: 'contrast(1.1) opacity(0.9) drop-shadow(0 0 10px rgba(0,0,0,0.5))' }}
